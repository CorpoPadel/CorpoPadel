...
<CalendarPrimitive.Day
	...
	class={cn(
		...
		'flex size-fit flex-col items-center justify-center gap-1 p-0 leading-none font-normal whitespace-nowrap select-none',
		...
		// Outside months
		'[&[data-outside-month]:not([data-selected])]:bg- [&[data-outside-month]:not([data-selected])]:text-muted-foreground [&[data-outside-month]:not([data-selected])]:hover:text-accent-foreground',
		// Disabled
